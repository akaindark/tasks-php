                               ...
                               <?php foreach ($users as $user):?>
                                   <div class="<?php echo $user['is_banned'] ? "banned " : ""; ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                       ...
                                       <div class="ml-2 mr-3">
                                           ...
                                           <a href="<?php $user['twitter_href'];?>" class="text-info fs-sm" target="_blank"><?php $user['twitter_account'];?></a> -
                                           <a href="<?php $user['email_link'];?>" class="text-info fs-sm" target="_blank" title="Contact Sunny"><i class="fal fa-envelope"></i></a>
                                       </div>
                                   </div>
                               <?php endforeach;?>
